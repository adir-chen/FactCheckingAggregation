...
class CommentTests(TestCase):
    ...
    def test_get_all_comments_for_user_id_test_1(self):
    ...
    def test_get_all_comments_for_user_id_test_2(self):
        user_3 = User(username="User3", email='user3@gmail.com', state='Regular', reputation=-1)
        user_3.save()

        comment_4 = Comment(claim_id=self.claim_1.id, user_id=user_3.id, title=self.claim_1.title,
    ...
    def test_get_all_comments_for_user_id_test_3(self):
        result = get_all_comments_for_user_id(3)
        self.assertTrue(result is None)

    def test_get_all_comments_for_claim_id_test_1(self):
    ...
    def test_get_all_comments_for_claim_id_test_2(self):
        user_3 = User(username="User3", email='user3@gmail.com', state='Regular', reputation=-1)
        user_3.save()
    ...
    def test_get_all_comments_for_claim_id_test_3(self):
    ...
    def test_get_category_for_claim_test_1(self):
    ...
    def test_get_category_for_claim_test_2(self):
        claim_3 = Claim(title='claim3', category='category3', authentic_grade=-1)
        claim_3.save()
        self.assertTrue(get_category_for_claim(claim_3.id) == claim_3.category)

    def test_add_comment_test_1(self):
        len_comments = len(Comment.objects.all())
        add_comment(self.claim_1.id, self.user_2.id, self.claim_1.title,
        ...
        self.assertTrue(new_comment.title == self.claim_1.title)

    def test_add_comment_test_2(self):
        len_comments = len(Comment.objects.all())
        user_3 = User(username="User3", email='user3@gmail.com', state='Regular', reputation=-1)
        user_3.save()

        comment_4 = Comment(claim_id=self.claim_2.id, user_id=user_3.id, title=self.claim_2.title,
                            description='description4', url='url1', verdict_date='verdict_date1',
                            tags='tags1', label='label1', pos_votes=0, neg_votes=0)

        add_comment(self.claim_2.id, user_3.id, self.claim_2.title,
                    'description3', 'url3', 'verdict_date3', 'tags3', 'label3')
        self.assertTrue(len(Comment.objects.all()) == len_comments + 1)
        new_comment = Comment.objects.all().order_by('-id')[0]
        self.assertTrue(new_comment.id == 4)
    ...
    def test_export_to_csv_test_1(self):
        res = export_to_csv()
    ...
    def test_export_to_csv_test_2(self):
        reset_comments()
        res = export_to_csv()
        self.assertTrue(res.status_code == 200)
        print(res.content == b'')