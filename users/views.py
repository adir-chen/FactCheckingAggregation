...
def add_all_scrapers():
    ...
    scraper_1.save()
    scraper_1_img = UsersImages(user_id=scraper_1, user_img='https://www.snopes.com/content/themes/snopes/dist/images/logo-s-crop-on.svg')
    scraper_1_img.save()
    scraper_1_rep = UsersReputations(user_id=scraper_1, user_rep=0)
    scraper_1_rep.save()
    ...
    scraper_2.save()
    scraper_2_img = UsersImages(user_id=scraper_2, user_img='https://www.polygraph.info/Content/responsive/RFE/en-Poly/img/logo.png')
    scraper_2_img.save()
    scraper_2_rep = UsersReputations(user_id=scraper_2, user_rep=0)
    scraper_2_rep.save()
    ...
    scraper_3.save()
    scraper_3_img = UsersImages(user_id=scraper_3, user_img='https://dn.truthorfiction.com/wp-content/uploads/2018/10/25032229/truth-or-fiction-logo-tagline.png')
    scraper_3_img.save()
    scraper_3_rep = UsersReputations(user_id=scraper_3, user_rep=0)
    scraper_3_rep.save()
    ...
    scraper_4.save()
    scraper_4_img = UsersImages(user_id=scraper_4, user_img='https://static.politifact.com/images/POLITIFACT_logo_rgb141x25.png')
    scraper_4_img.save()
    scraper_4_rep = UsersReputations(user_id=scraper_4, user_rep=0)
    scraper_4_rep.save()
    ...
    scraper_5.save()
    scraper_5_img = UsersImages(user_id=scraper_5, user_img='https://s3.gossipcop.com/thm/gossipcop/images/horizontal-logo.png')
    scraper_5_img.save()
    scraper_5_rep = UsersReputations(user_id=scraper_5, user_rep=0)
    scraper_5_rep.save()
    ...
    scraper_6.save()
    scraper_6_img = UsersImages(user_id=scraper_6, user_img='https://climatefeedback.org/wp-content/themes/wordpress-theme/dist/images/Climate_Feedback_logo_s.png')
    scraper_6_img.save()
    scraper_6_rep = UsersReputations(user_id=scraper_6, user_rep=0)
    scraper_6_rep.save()
    ...
    scraper_7.save()
    scraper_7_img = UsersImages(user_id=scraper_7, user_img='http://factscan.ca/test/wp-content/uploads/2015/02/web-logo.png')
    scraper_7_img.save()
    scraper_7_rep = UsersReputations(user_id=scraper_7, user_rep=0)
    scraper_7_rep.save()
    ...
    scraper_8.save()
    scraper_8_img = UsersImages(user_id=scraper_8, user_img='https://upload.wikimedia.org/wikipedia/en/2/2f/Africa_Check_Website_logo.png')
    scraper_8_img.save()
    scraper_8_rep = UsersReputations(user_id=scraper_8, user_rep=0)
    scraper_8_rep.save()
